...
**Grupo do Renzo (Grupo 2)**: Marinho · Leandro Castro · Isabela · Clara Janke · Ana Flávia · Renzo Tognella. Tema: *Carreira e novos modelos de trajetória*.

---

## 2. Recrutamento e Seleção

### 2.1 A Economia do Recrutamento

A aula abre com dados concretos do mercado norte-americano:
...
O Google é usado como benchmark do processo de recrutamento em empresas de alta competitividade.

**Modelo antigo** (Google inicial):
```
Candidatura → Triagem pelo especialista do cargo → Entrevista por vídeo →
Entrevista presencial (gerente + pares) → Feedback informal →
Gerente decide → Oferta
```
...
**Mudanças-chave:** (1) triagem passa de specialist único para generalista de talentos; (2) subordinados participam do avaliação (feedback descendente); (3) múltiplos entrevistadores interfuncionais ampliam a perspectiva; (4) a decisão deixa de ser individual e passa por camadas sucessivas, reduzindo viés.
...
|:---|:---|:---|
| Tempo de adaptação | Menos (já conhece a cultura) | Mais (precisa aprender) |
| Custo | Menor | Maior |
...
### 3.1 Definição: Duas Perspectivas

Dutra (1996, com base em London e Stumpf) apresenta a carreira com duas perspectivas complementares:

- **Perspectiva da organização**: definição de políticas, procedimentos e decisões sobre espaços ocupacionais, níveis organizacionais, compensação e movimentação de pessoas.
- **Perspectiva do indivíduo**: autoconhecimento, avaliação de sua identidade e experiência profissional.

A carreira é a sequência de posições ocupados e de trabalhar realizados durante a vida — uma sequência de estágios e transições que refletem necessidades, motivos e aspirações individuais, bem como expectativas e imposições da organização e da sociedade.

### 3.2 Autogerenciamento da Carreira

> "É um processo de reflexão, de autoconhecimento, que direciona as ações profissionais." (adaptado de Dutra)
...
| Etapa | Conteúdo |
|:---:|:---|
| **1. Autoconhecimento** | Realizações, pontos fortes e fracos, feedback de amigos/família/colegas, instrumentos de investigação, conselheiros profissionais |
| **2. Objetivos de Carreira** | Objetivos de médio e longo prazo nas áreas: profissional, familiar, econômico-financeira, pessoal e social. Indicadores de sucesso, fatores críticos, recursos necessários |
| **3. Plano de Ação** | Metas de curto e médio prazo, indicadores, fatores críticos, recursos (tempo, financeiros, contatos, educação, saúde), revisão periódica |
| **4. Acompanhamento** | Monitoramento contínuo, autoconhecimento contínuo, reação a mudanças externas |

Vídeo complementar: https://www.youtube.com/watch?v=-ofFHBNrW8c
...
|:---:|:---:|:---|
| **Autonomia e Independência** | AI | Liberdade no ritmo, forma e padrão do trabalho. Profissionais que precisam ser seus próprios chefes |
...
Teste online recomendado: https://agoraentert.com.br/antigosite/insights/test/teste-ancoras-de-carreira/

### 3.5 Ciclos de Influências (Edgar Schein)

Três ciclos paralelos afetam as decisões de carreira ao longo da vida:
...
| Armadilha | Sintomas | Iscas que as disfarçam |
|:---|:---|:---|
...
As "iscas" são recompensas aparentes que mascaram o caminho errado — a lição é desconfiar de decisões de carreira baseadas apenas em attractores imediatos.
...
- EXAME. "Empresas brasileiras dispensam o diploma na hora de contratar", 22.out.2018.
- TECNOBLOG. "Apple, Google e IBM dispensam diploma universitário", 2018.

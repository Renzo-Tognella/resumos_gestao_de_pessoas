# Proposta de Valor ao Empregado (EVP) e Marca Empregadora: Referência Acadêmica Abrangente
...
### 1.2 A Equação de Ambler & Barrow (1996–2000)
...
### 1.3 O Modelo de Total Rewards de Berard & Pabon (1992)
...
#### 1.3.2 Benefits (Benefícios)
Programas de proteção e suporte que complementam a compensação:
- Plano de saúde (médico, odontológico)
...
- Licença maternidade/paternidade expandida
- Sabbatical leaves
...
A EVP é, portanto, a **tradução interna** da marca empregadora: enquanto a marca empregadora comunica-se para o mercado externo (candidatos, clientes, sociedade), a EVP é a promessa Internalizada e experienciada pelos colaboradores atuais.

### 2.2 Estrutura da EVP
...
## 3. Employee Experience (EX) e Impacto Financeiro
...
```
Organizations with excellent Employee Experience outperform others
on the stockmarket by 22% to 47% in total return to shareholders (TRS).
```

#### Principais Achados:

- Organizações classificadas como tendo **" Employee Experience excelente"** apresentaramextraordinary retorno acionário entre 22% e 47% superior a organizações comparáveis
- Colaboradores em ambientes de alta experiencia reportaram **40% menos intenção de turnover**
- A conexão entre EX e NPS (Net Promoter Score) do cliente era **3x mais forte** em organizações com alta EX
- Apenas **27% dos executivos** acreditavam que sua organização oferecia uma boa experiência de trabalho — um gap significativo

#### Modelo EX da McKinsey:

A McKinsey propôs que a EX se constrói em **três camadas**:

1. **Functional EX** — os aspectos práticos: ferramentas, processos, ambiente físico
2. **Emotional EX** — como o Colaborador se sente: orgulho, pertencimento, respeito
3. **Purpose EX** — o sentido mais profundo do trabalho: impacto, contribuição, missão

### 3.2 Evolução Posterior: McKinsey 2020–2023

Estudos subsequentes da McKinsey refinarram o modelo:

- Em **2020**, identificou-se que organizações com alta EX têm **2x mais capacidade de inovar** durante crises
- Em **2022**, demonstrou-se que a EX explica até **33% da variância em Productivity** após controle de variáveis demográficas
- O conceito de **"quadrivolt"** — combinando wellbeing, flexibility, digital enablement e purpose-driven culture — emergiu comoframework para o novo normal pós-pandémico
...
| Mecanismo | Descrição |
|---|---|
| **"Culture Code" deck** | Documento vivamente compartilhado, lido por novos funcionários como parte do onboarding |
...
A Gympass investiu massivamente em employer branding:
- Presença em rankings internacionais (LinkedIn Top Startups, Glassdoor Best Places)
- Campanhas de employer branding que destacavam a cultura de inovação
- "Gympass Life" — conteúdo de marca empregadora em redes sociais mostrando o dia a dia
...
## 5. Estatísticas sobre Impacto da Marca Empregadora

### 5.1 Evidências Quantitativas Recentes
...
### 5.2 O Ciclo Virtuoso da Marca Empregadora

A evidência acumulada sugere um **ciclo de retroalimentação positiva**:

```
Marca Empregadora Forte
        ↓
Candidatos de maior qualidade aplicam
        ↓
Maior retenção de talentos de alto desempenho
        ↓
Melhor ambiente e cultura de trabalho
        ↓
Glassdoor/avaliações melhoram
        ↓
...
**Barrow, S.** (1996). A abordagem de marca ao employer. Internal BT Strategy Paper. London: British Telecom.

**Barrow, S. & Ambler, T.** (1996). Toward a Better Model of Employer Brand equity. *Journal of Brand Management*, 3(4), 209-222.

### 6.2 Estudos de Consultoria

**McKinsey & Company** (2017). *The Hero's Journey: Why Employee Experience is the Next Competitive Advantage*. McKinsey Quarterly.

**McKinsey & Company** (2020). *Reinventing the Employee Experience: Lessons from the Pandemic*. McKinsey People Analytics.

**McKinsey & Company** (2023). *The State of Organizations: Evidence from the Post-Pandemic Era*. McKinsey Human Arithmetic Practice.

**Deloitte** (2022). *Global Human Capital Trends Report*. Deloitte Consulting LLP.
...
### 6.3 Publicações Académicas

**Backhaus, K. & Tikoo, S.** (2004). Conceptualizing Employer Branding and Employer Brand Equity. *Journal of Vocational Behavior*, 66(3), 500-524.

**Bispo, A. & Nascimento, A.M.P.** (2022). Marca Empregadora e Proposta de Valor ao Empregado: Uma Revisão Sistemática da Literatura. *Revista de Gestão de Pessoas*, 45(2), 112-130.

**Edelman** (2021). *Employer Brand Management: From Concept to Practice*. New York: Routledge.
...
**HubSpot** (2022). *HubSpot Culture Code 3.0*. Disponível em: https://www.hubspot.com/culture (accessed May 2026).

**Gympass/Wellhub** (2023). *Wellhub Annual Report*. Disponível em: https://wellhub.com (accessed May 2026).
...
*Documento elaborado para fins académicos — Disciplina: Gestão de Pessoas / Aula 11*  
*Universidade/Instituição: SEA Chief Executive Programme*  
*Data: Maio 2026*
